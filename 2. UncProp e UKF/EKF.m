function [xx_filtered, P_filtered, flag] = EKF(x0, tt, measurements, P0, spacecraft_data, sigma_meas, sigma_acc, xx_truth)
...
for i = 1:(length(tt)-1)
    ...
    [~, xx, PHI]  = propagateEllipsoid(x_start', [tt(i), tt(i+1)], mass_eros, omega_body, C20, C22);
