function dy = dynamicsEllipsoidEKF( t, y, mass, omega, C20, C22, tao, QR)
...
[acc_shp, G] = Recursive_Spherical_armonics_perturbation_ellipsoid_STM(y, mass, C20, C22);
...
A = [zeros(3, 3), eye(3), zeros(3), zeros(3);
     G, dGdv , zeros(3), zeros(3);
     zeros(3), zeros(3), -1/tao*eye(3), zeros(3);
     zeros(3), zeros(3), zeros(3), -1/tao*eye(3)];
