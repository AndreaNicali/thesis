...
spacecraft_data.data_guidance.process_noise = 8*10^-9;
...
iterations = 300; %Number of iterations per tree (As a reference, for 200 iterations 45 min/1 h are required)
...
[real_trajectory_GREEDY, filter_trajectory_GREEDY, ref_trajectory_GREEDY, P_greedy, real_times_GREEDY, ...
  mapping_scores_GREEDY, exploiting_scores_GREEDY, nav_scores_GREEDY, ...
  action_times_GREEDY, all_flag_GREEDY, planned_actions_GREEDY, real_trajectory_total_GREEDY, ref_trajectory_total_GREEDY, filter_trajectory_total_GREEDY, ...
  tt_all_GREEDY, mapping_score_total_GREEDY, exploiting_score_total_GREEDY, nav_score_total_GREEDY, P_all_GREEDY, spacecraft_data_out_GREEDY] = ...
...
figure(7)
dispersion_pos = vecnorm(ref_trajectory_total_GREEDY(:, 1:3)-real_trajectory_total_GREEDY(:, 1:3), 2, 2);
knowledge_pos = vecnorm(filter_trajectory_total_GREEDY(:, 1:3)-real_trajectory_total_GREEDY(:, 1:3), 2, 2);

dispe = plot((tt_all_GREEDY-tt_all_GREEDY(1))/3600, dispersion_pos, 'r', 'LineWidth', 1.5)
hold on
knowl = plot((tt_all_GREEDY-tt_all_GREEDY(1))/3600, knowledge_pos, 'b', 'LineWidth', 1.5)
grid on
grid minor
xlabel('Time [h]')
ylabel('Val [Km]')
