function [xx_filtered, P_filtered] = UKF_forsebuono(x0, tt, measurements, P0, spacecraft_data, sigma_meas, Qk)
...
for i = 1:(length(tt)-1)
    ...
    for j = 1:size(sp, 2)
        ...
        sim_measurements = feature_measurements(chi(:, j)', tt(i+1), spacecraft_data, sim_measurements);
