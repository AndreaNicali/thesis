function acc = Spherical_armonics_perturbation(y, mass, order)

%Compute the perturbating accelerations from spherical armonics of 433 Eros
%given the desired order
...
for n = 1:order
    for m = 0:(n)
        ...
        Cbar = eros_armonic(n, m, 'c');
        Sbar = eros_armonic(n, m, 's');
...
%Final moltiplication to scale the value
