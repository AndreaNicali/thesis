function [uu_opt,th_opt,J_opt,U,J,T,S,I] = exploreU(xx0,t0,spacecraft_data)
...
%         drawnow
        ...
        [J0,T0,S0] = EvaluateSet(t0,xx0,data_guidance.DeltaV_max*P(id_0,:)',spacecraft_data);
        ...
        while stop_flag == 0
            ...
            for l = 1:ns
                ...
                if isempty(id_l)
                    ...
                    % Evaluate the initial mesh
                    [J(id_l),T(id_l),S(id_l)] = EvaluateSet(t0,xx0,data_guidance.DeltaV_max*P(id_l,:)', spacecraft_data);
