function [J,T,S] = EvaluateSet(t0,xx0,U0,spacecraft_data)
...
% Score function
[J_hist, dJ_dt_hist] = score_rizza(xx, tt, spacecraft_data); % Can be any user defined function
...
for k = 2:size(U0,2)
    ...
    % Score function
    [J_hist, dJ_dt_hist] = score_rizza(xx_k, tt_k, spacecraft_data); % Can be any user defined function
